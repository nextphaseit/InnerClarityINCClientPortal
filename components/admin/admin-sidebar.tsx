...
const navigationItems = [
  ...
  { name: "Patients", href: "/admin/patients", icon: Users, roles: ["admin", "super_admin"] },
  { name: "Appointments", href: "/admin/appointments", icon: Calendar, roles: ["admin", "super_admin"] },
  { name: "Billing & Payments", href: "/admin/billing", icon: CreditCard, roles: ["admin", "super_admin"] },
  { name: "Messages", href: "/admin/messages", icon: MessageSquare, roles: ["admin", "super_admin"] },
  { name: "Telehealth", href: "/admin/telehealth", icon: Video, roles: ["admin", "super_admin"] },
  { name: "Documents", href: "/admin/documents", icon: FileText, roles: ["admin", "super_admin"] },
  { name: "Forms", href: "/admin/forms", icon: ClipboardList, roles: ["admin", "super_admin"] },
  { name: "Calendar", href: "/admin/calendar", icon: CalendarDays, roles: ["admin", "super_admin"] },
  { name: "Health Logs", href: "/admin/health-logs", icon: Activity, roles: ["admin", "super_admin"] },
  { name: "Invoices", href: "/admin/invoices", icon: Receipt, roles: ["admin", "super_admin"] },
  { name: "Audit Logs", href: "/admin/audit-logs", icon: Shield, roles: ["super_admin"] },
  { name: "Admin Users", href: "/admin/users", icon: UserCog, roles: ["super_admin"] },
]
        ...
        {filteredNavigation.map((item) => {
          ...
          return (
            ...
            >
              <Icon
                className={`
                  ${collapsed ? "mx-auto" : "mr-3"} h-5 w-5 transition-colors duration-200
      ...
      <div className="border-t border-gray-200 dark:border-gray-800 p-4">
        ...
        <div className={`space-y-2 ${collapsed ? "flex flex-col items-center" : ""}`}>
          ...
          <Button
            ...
            size="sm"
            onClick={signOut}
            className={`${collapsed ? "w-8 h-8 p-0" : "w-full justify-start"} text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950`}
          >
