...
export function Navigation() {
  ...
  if (status === "loading") {
    return (
      <nav className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-b border-gray-100 dark:border-gray-800 shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center">
              <div className="h-8 w-8 bg-gray-200 dark:bg-gray-700 rounded-full animate-pulse"></div>
              <div className="ml-3 h-6 w-32 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
            </div>
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center space-x-1 px-3 py-2 rounded-md text-sm font-medium transition-colors
                        ${
                          isActive
                            ? "text-clarity-blue-600 dark:text-clarity-blue-400 bg-clarity-blue-50 dark:bg-clarity-blue-900/20"
                            : "text-gray-700 dark:text-gray-300 hover:text-clarity-blue-600 dark:hover:text-clarity-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800"
                        }`}
                    >
            ...
            {session?.user ? (
              ...
              <Button
                asChild
                className="bg-clarity-blue-600 hover:bg-clarity-blue-700 text-white font-medium px-6 py-2 rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md"
              >
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            {!session?.user && (
              <Button
                asChild
                size="sm"
                className="bg-clarity-blue-600 hover:bg-clarity-blue-700 text-white font-medium px-4 py-2 rounded-lg transition-colors duration-200"
              >
                <Link href="/auth/signin">Sign In</Link>
              </Button>
            )}
            ...
            {breadcrumbs.map((breadcrumb, index) => (
              <div key={breadcrumb.href} className="flex items-center">
                ...
                {index === breadcrumbs.length - 1 ? (
                  ...
                  <Link href={breadcrumb.href} className="hover:text-clarity-blue-600 dark:hover:text-clarity-blue-400">
