  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome to the Admin Dashboard</h1>
        <p className="text-gray-600">
          Logged in as: <span className="font-medium">{session.user.email}</span>
        </p>
        <p className="text-sm text-gray-500 mt-1">Provider: Microsoft Entra ID | Role: Administrator</p>
      </div>
